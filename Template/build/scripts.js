...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _input_group = __webpack_require__(1);
	...
	window.onload = function () {
		var inputGroups = _input_group2.default.initInputGroups();
		var generateButton = document.getElementById("generate-btn");
		generateButton.addEventListener("click", function () {
			generateVariant(_input_group2.default.getAllValues(inputGroups));
		});
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var InputGroup = function () {
	  ...
	  */
		function InputGroup(input, dec_btn, inc_btn, value, min_value, max_value) {
	  ...
	  */
	   ...
	   */
			...
			key: "initInputGroups",
			value: function initInputGroups() {

				// empty array for members of InputGroup class
				var data = [];

				// get all input groups on the page
				var InputGroups = [].concat((0, _toConsumableArray3.default)(document.getElementsByClassName("input-group")));

				InputGroups.forEach(function (inputGroup) {

					// get buttons
					var _ref = [].concat((0, _toConsumableArray3.default)(inputGroup.getElementsByTagName("button"))),
					    dec_btn = _ref[0],
					    inc_btn = _ref[1];
					...
					var input = inputGroup.getElementsByClassName("form-control")[0];

					// get attributes of input element
					var value = parseInt(input.value);
					var min_value = parseInt(input.min);
					var max_value = parseInt(input.max);
	   ...
	   */
			...
			key: "getAllValues",
			value: function getAllValues(inputGroups) {
				return inputGroups.map(function (inputGroup) {
					return inputGroup.getValue();
				});
			}
		}]);
		return InputGroup;
